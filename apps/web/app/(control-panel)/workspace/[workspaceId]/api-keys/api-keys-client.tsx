...
import type { AiApiKeyInfo } from "../../../../src/actions/workspace/workspace-info";
...
export function ApiKeysClient({ workspaceId, keys }: Props) {
  ...
  const activeCount = keys.filter((k) => k.status === "AVAILABLE").length;
                  ...
                  <tr key={key.id} className="hover:bg-[#f3f3fe] transition-colors group">
                    ...
                    <td className="px-[24px] py-[16px] text-right">
                      <div className="opacity-0 group-hover:opacity-100 transition-opacity flex justify-end gap-[8px]">
                        <button className="p-2 hover:bg-[#e7e7f3] rounded-lg text-[#434655] transition-colors" title="Edit">
                        ...
                        <button className="p-2 hover:bg-[#ffdad6] hover:text-[#ba1a1a] rounded-lg text-[#434655] transition-colors" title="Delete">
