...
export function RegistrationForm() {
  ...
  const onSubmit = handleSubmit(async (values) => {
    ...
    if (result.status === "success") {
      ...
      notify({ title: "Account created", message: "Check your inbox to verify your email address.", tone: "success" });
      router.replace("/profile");
      return;
    }
    notify({ title: "Registration unavailable", message: result.message, tone: "error" });
  });
